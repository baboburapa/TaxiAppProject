...
public class MyCookieManager {
     ...
     */
    public void setCookies(HttpsURLConnection conn) throws IOException {
	...
	MyCookieManager cm = new MyCookieManager();
	try {
	    URL url = new URL("https://app.rtic-thai.info/tms/main/");
	    ...
	    cm.setCookies((HttpsURLConnection) url.openConnection());
